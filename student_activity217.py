...
try:
    ...
    def _Radar_callback(radar_data):
        ...
        for detect in radar_data:
            ...
            forward_view = carla.Vector3D(x=detect.depth - 1)
            ...
            carla.Transform(carla.Location(),carla.Rotation(
                pitch=new_pitch,yaw=new_yaw,roll=new_roll)).transform(forward_view)
            debug.draw_point(
                radar_data.transform.location+forward_view,
                'radar',life_time=0.06,color=carla.Color(0,210,255))
